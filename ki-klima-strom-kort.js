...
// Nytt navn (HACS-repo ki-klima-strom-kort) — gammelt navn beholdes så eksisterende dashboards virker.
if (!customElements.get("ki-klima-strom-kort")) {
  customElements.define("ki-klima-strom-kort", class extends KiKlimaProCard {});
}
window.customCards = window.customCards || [];
window.customCards.push({
  type: "ki-klima-strom-kort",
  name: "KI Klima Strøm",
  description: "Hele klima- og energisystemet fra KI Energi: status, soner, energi, varmtvann, motorens resonnement og logg",
  preview: true,
  documentationURL: "https://github.com/SebastianKristo/ki-klima-strom-kort",
});
console.info("%c KI-KLIMA-STROM-KORT %c v" + KI_PRO_VERSJON + " ", "background:#1e3a5f;color:#fff;font-weight:700;border-radius:4px 0 0 4px", "background:#f77f00;color:#0f2033;font-weight:700;border-radius:0 4px 4px 0");
